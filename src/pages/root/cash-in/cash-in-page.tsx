...
import CashInForm from './components/cash-in-form';
                        ...
                        <div className={`card-${isSuccess ? 'green' : 'pink'} rounded-lg p-8 mb-6`}>
                            {isSuccess ? (
                                <>
                                    ...
                                    <p>Your money has been successfully cash in.</p>
                                </>
                            ) : (
                                <>
                                    <XCircle className="w-16 h-16 mx-auto mb-4" />
                                    <h2 className="text-2xl font-bold mb-2">Cash In Failed</h2>
                    ...
                    <div className="w-full max-w-md">
                        <div className="text-center mb-8">
                            <div className="inline-flex items-center gap-2 mb-4">
                                ...
                                <h1 className="text-4xl font-bold">Cash In</h1>
                            </div>
                        </div>
                        <StepsIndicator step={step} />
                        <CashInForm step={step} setStep={setStep} setIsSuccess={setIsSuccess} setShowConfirmation={setShowConfirmation} formData={formData} setFormData={setFormData} />
                    </div>
                </div>
            )}
        </>
